...
$sql1="select category.id as category_id, category.name as category_name, sub_category.name as sub_category_name from category join sub_category on sub_category.category_id=category.id where category.is_deleted=0 and sub_category.is_deleted=0 and sub_category.sub_category_id={$_POST['sub_category_id']}";
