                ...
                <div class="d-flex">
                    ...
                    <div class="col">
                        <div class="">
                            ...
                            <span class="" style="font-size: 15px;">'.ucwords($row['sub_category_name']).'</span>
                        </div>
                    </div>
                </div>
            </div>
