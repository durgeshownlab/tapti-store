                    ...
                    <div class="box_general summary">
                        <ul>
                            ...
                            if (mysqli_num_rows($result1) > 0) {
                                ...
                                <div class="total clearfix">TOTAL <span>&#8377;' . number_format($total) . '</span></div>
                            ...
                            <a href="cartConfirm.php" class="btn_1 full-width" id="place-cart-order-btn">Confirm and Order</a>
                    </div>
                    <!-- /box_general -->
                </div>
                <!-- /step -->
